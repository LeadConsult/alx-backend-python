...
if everything defined outside this function works
as expected, does this function work as expected?
...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self, mocked_method):
        ...
        Args:
            mocked_method (_type_): _description_
        """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
        Test the GithubOrgClient integration
    """
    @classmethod
    def setUpClass(cls):
